...
class LGChatController : UIViewController, UITableViewDelegate, UITableViewDataSource, LGChatInputDelegate {
    ...
    private func listenForKeyboardChanges() {
        ...
        defaultCenter.addObserver(self, selector: #selector(keyboardWillChangeFrame(_:)), name: UIKeyboardWillChangeFrameNotification, object: nil)
    }
...
class LGChatInput : UIView, LGStretchyTextViewDelegate {
    ...
    func setupSendButton() {
        ...
        self.sendButton.addTarget(self, action: #selector(sendButtonPressed(_:)), forControlEvents: .TouchUpInside)
