...
class InputView: UIToolbar,UITextViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate{
    ...
    override init(frame: CGRect) {
        ...
        rightButton.addTarget(self, action: #selector(InputView.sendImage), forControlEvents: .TouchUpInside)
    ...
    func sendMessage(imageBlock imageBlock:ImageBlock, textBlock:TextBlock, voiceBlock:VoiceBlock){
        sendImageBlock = imageBlock
        sendTextBlock = textBlock
        sendVoiceBlock = voiceBlock
    }
